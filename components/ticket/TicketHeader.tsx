...
import { Check, UserPlus, RefreshCw, Star, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="bg-white p-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shrink-0 shadow-sm z-10">
      <div className="flex items-start gap-3">
        <button 
          onClick={() => navigate(-1)}
          className="mt-1 p-2 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors"
          title="Voltar"
        >
          <ArrowLeft size={20} />
        </button>
